...
$(document).ready(function() {
	...
	PlayerUI = {	
		...
		changeBackground: function() {
			...
			$('html, body').css({'background':'linear-gradient(to bottom, rgba('+rgb.r+','+rgb.g+','+rgb.b+', 100), #FAFAFA)','transition':'all 0.7s ease-in'});
		},
	...
	/* For Recommenedations */
  	...
  	$('#trend').click(function(e){
  		// set the playlist title
  		$('#playlist-title').html('<span id="selected-playlist">Search a Song</span>');
  		// Hide unneccessary divs
