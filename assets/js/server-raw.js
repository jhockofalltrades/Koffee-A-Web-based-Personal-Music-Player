		...
		success: function(data) {
			if(data.length > 0 ) {
				$.each(data, function(key, val){
					results += '<img src="'+val.album_art+'" alt="'+val.title+'" data-toggle="tooltip" data-placement="bottom" data-artist="'+val.artist+'" data-title="'+val.title+'" class="img-responsive img-circle most-played-thumb">';
				})
			} else {
